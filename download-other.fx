                  ...
                  <ul class="list-group list-group-flush text-center">
                    ...
                    <li class="list-group-item"><i class="icon-ok text-info"></i>',$lang['download-other-22'],'</li>
      						...
      						<div class="panel-footer">
      							<a class="btn btn-lg btn-block btn-info" href="https://cdimage.foxxysec.org/foxxy/iso/arm/rpi">',$lang['download-other-23'],'</a>
      						</div>
      					</div>
              </div>
                ...
                <div class="panel download panel-blue">
                  ...
                  <ul class="list-group list-group-flush text-center">
                    ...
                    <li class="list-group-item"><i class="icon-ok text-info"></i>',$lang['download-other-27'],'</li>
      						...
      						<div class="panel-footer">
      							<a class="btn btn-lg btn-block btn-info" href="https://cdimage.foxxysec.org/foxxy/iso/arm/opi">',$lang['download-other-23'],'</a>
      						</div>
      					</div>
              </div>
                ...
                <div class="panel download panel-blue">
                  ...
                  <ul class="list-group list-group-flush text-center">
                    ...
                    <li class="list-group-item"><i class="icon-ok text-info"></i>',$lang['download-other-32'],'</li>
      						...
      						<div class="panel-footer">
      							<a class="btn btn-lg btn-block btn-info" href="https://cdimage.foxxysec.org/foxxy/iso/arm/pine64">',$lang['download-other-23'],'</a>
      						</div>
      					</div>
              </div>
