...
<html>
  ...
  <meta property="og:site_name"   content="Foxxy Security"/>
  <meta property="og:url"         content="https://www.foxxysec.org" />
  <meta property="og:image"       content="https://www.foxxysec.org/img/facebook-preview.png" />
      ...
      <div class="container-fluid">
          ...
          <div class="navbar-collapse collapse" id="bs-navbar">
              <ul class="nav navbar-nav">
                  ...
                  <li>
                      <a class="page-scroll" href="https://blog.foxxysec.org">',$lang['nav-4'],'</a>
                  </li>
                  <li>
                      <a class="page-scroll" href="https://docs.foxxysec.org">',$lang['nav-5'],'</a>
                  </li>
                  <li>
                      <a class="page-scroll" href="https://dev.foxxysec.org" target="_blank">',$lang['nav-6'],'</a>
                  </li>
                  <li>
                      <a class="page-scroll" href="https://docs.foxxysec.org/community">',$lang['nav-7'],'</a>
                  </li>
                  <li>
                      <a class="page-scroll" href="https://docs.foxxysec.org/partners">',$lang['nav-8'],'</a>
                  </li>
                  <li>
                      <a class="page-scroll" href="https://docs.foxxysec.org/developers">',$lang['nav-9'],'</a>
                  </li>
                  <li>
                      <a class="page-scroll" href="https://docs.foxxysec.org/donate">',$lang['nav-10'],'</a>
                  </li>
                  <li>
                      <a class="page-scroll" href="https://docs.foxxysec.org/FAQ">',$lang['nav-11'],'</a>
                  </li>
              </ul>
              <ul class="nav navbar-nav navbar-right">
                  <li>
                      <a class="page-scroll" href="https://dev.foxxysec.org/foxxy/foxxysec.org" target="_blank">',$lang['nav-12'],'</a>
                  </li>
              </ul>
          </div>
      </div>
